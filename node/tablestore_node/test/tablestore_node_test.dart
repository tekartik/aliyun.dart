...
void main() {
  ...
  group('tablestore_node', () {
    test('keyType', () {
      ...
      expect(
        tsNodeCommon.primaryKeyType.INTEGER,
        tsNodeCommonShim.primaryKeyType.INTEGER,
      );
      expect(
        tsNodeCommon.primaryKeyType.STRING,
        tsNodeCommonShim.primaryKeyType.STRING,
      );
      expect(
        tsNodeCommon.primaryKeyType.BINARY,
    ...
    test('rowExistenceExpectation', () {
      ...
      expect(
        tsNodeCommon.rowExistenceExpectation.IGNORE,
        tsNodeCommonShim.rowExistenceExpectation.IGNORE,
      );
      expect(
        tsNodeCommon.rowExistenceExpectation.EXPECT_EXIST,
        tsNodeCommonShim.rowExistenceExpectation.EXPECT_EXIST,
      );
      expect(
        tsNodeCommon.rowExistenceExpectation.EXPECT_NOT_EXIST,
    ...
    test('ReturnType', () {
      ...
      expect(
        tsNodeCommon.returnType.Primarykey,
        tsNodeCommonShim.returnType.Primarykey,
      );
      expect(
        tsNodeCommon.returnType.AfterModify,
    ...
    test('ComparatorType', () {
      ...
      expect(
        tsNodeCommon.comparatorType.EQUAL,
        tsNodeCommonShim.comparatorType.EQUAL,
      );
      expect(
        tsNodeCommon.comparatorType.NOT_EQUAL,
        tsNodeCommonShim.comparatorType.NOT_EQUAL,
      );
      expect(
        tsNodeCommon.comparatorType.GREATER_THAN,
        tsNodeCommonShim.comparatorType.GREATER_THAN,
      );
      expect(
        tsNodeCommon.comparatorType.GREATER_EQUAL,
        tsNodeCommonShim.comparatorType.GREATER_EQUAL,
      );
      expect(
        tsNodeCommon.comparatorType.LESS_THAN,
        tsNodeCommonShim.comparatorType.LESS_THAN,
      );
      expect(
        tsNodeCommon.comparatorType.LESS_EQUAL,
    ...
    test('LogicalOperator', () {
      ...
      expect(
        tsNodeCommon.logicalOperator.NOT,
        tsNodeCommonShim.logicalOperator.NOT,
      );
      expect(
        tsNodeCommon.logicalOperator.AND,
        tsNodeCommonShim.logicalOperator.AND,
      );
      expect(
        tsNodeCommon.logicalOperator.OR,
        tsNodeCommonShim.logicalOperator.OR,
      );
    });
    ...
    test('Direction', () {
      ...
      expect(
        tsNodeCommon.direction.FORWARD,
        tsNodeCommonShim.direction.FORWARD,
      );
      expect(
        tsNodeCommon.direction.BACKWARD,
        tsNodeCommonShim.direction.BACKWARD,
      );
    });
